...
export const CSS_VARIABLES = {
  ...
  "--c-success-border": system.success[500],
  "--c-success-bg": lightDark(system.success[50], system.success[950]),
  "--c-danger": system.destructive[800],
  "--c-error-border": system.destructive[500],
  "--c-error-bg": lightDark(system.destructive[50], system.destructive[950]),
